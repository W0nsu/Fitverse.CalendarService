...
namespace Fitverse.CalendarService.MessageBus.Recivers
{
	public class EditMemberReciver : BackgroundService
	{
		...
		private void InitializeRabbitMqListener()
		{
			...
			_channel.QueueDeclare("CS_EditMember", false, false, false, null);
			_channel.QueueBind("CS_EditMember", "members", "editMember", null);
		}
		...
		protected override Task ExecuteAsync(CancellationToken stoppingToken)
		{
			...
			consumer.Received += (ch, ea) =>
			{
				...
				memberEntity.Email = editedMemberEntity.Email;
			...
			_channel.BasicConsume("CS_EditMember", false, consumer);

...
namespace Fitverse.CalendarService.MessageBus.Recivers
{
	public class AddMemberReciver : BackgroundService
	{
		...
		private void InitializeRabbitMqListener()
		{
			...
			_channel.QueueDeclare("CS_AddMember", false, false, false, null);
			_channel.QueueBind("CS_AddMember", "members", "addMember", null);
		}
		...
		protected override Task ExecuteAsync(CancellationToken stoppingToken)
		{
			...
			_channel.BasicConsume("CS_AddMember", false, consumer);
